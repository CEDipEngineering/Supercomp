...
int smithwaterman_score_seq(
    ...
    // thrust::fill(Temp_begin, Temp_end, 0);
    /*
    ...
    std::cout << std::endl;
    thrust::transform(bigstr_begin, bigstr_end, bigstr_begin, PrintVec<char>());
    std::cout << std::endl;
    thrust::transform(smallstr_begin, smallstr_end, smallstr_begin, PrintVec<char>());
    std::cout << std::endl;
    */
